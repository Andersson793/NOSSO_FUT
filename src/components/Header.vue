...
<template>
    <header class="bg-green-400 border-b-4 border-neutral">
      <div class="flex justify-center py-2 items-center">
        ...
        <div class="cursor-pointer absolute right-8 hover:bg-gray-100/25 rounded-lg flex justify-center items-center p-1">
          <img @click="alterOpen()" class="w-6 h-auto" src="../assets/seta-para-baixo.png" alt="V">
        </div>
      </div>
      <Select :isOpen="open"></Select>
    </header>
    <Partidas/>
</template>